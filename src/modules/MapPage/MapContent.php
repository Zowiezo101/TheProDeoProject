<?php
    require "src/modules/MapPage/MapDefault.php";
    require "src/modules/MapPage/MapDetails.php";

    class MapContent extends Module {
        private $id;
        ...
        public function __construct($params = []) {
            ...
            $this->default = new MapDefault();
            
            // The content when an ID is given
            $this->details = new MapDetails();
