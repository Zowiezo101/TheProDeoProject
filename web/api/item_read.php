...
if ($conn->connect_error) {
     ...
     * - calculations
     */
    $table = checkParam(filter_input(INPUT_POST, 'table'));
    $id = checkParam(filter_input(INPUT_POST, 'id'));
    $columns = checkParams(split(';', filter_input(INPUT_POST, 'columns')));
    $filters = checkParams(split(';', filter_input(INPUT_POST, 'filters')));
    $calculations = checkParams(split(';', filter_input(INPUT_POST, 'calculations')));
