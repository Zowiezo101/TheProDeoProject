        ...
        <div id="navigation" class="row">
            ...
            <div id="div_timeline" class="col-md-2"><script>makeButton("timeline", "div_timeline");</script></div>
            <div id="div_familytree" class="col-md-2"><script>makeButton("familytree", "div_familytree");</script></div>
            <div id="div_worldmap" class="col-md-2"><script>makeButton("worldmap", "div_worldmap");</script></div>

            <!-- Dropdown menu for Pro Deo items -->
            <div id="dropdown_prodeo_div" class="col-md-2">
