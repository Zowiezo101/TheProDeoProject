...
function locations_Helper_layout() {
    ...
    PrettyPrint('        <div id="button_bar"> ');
                    // Previous page
    PrettyPrint('            <button id="button_left" class="button_'.$locations.'" onClick="PrevPage()"> ');
    PrettyPrint('                ← ');
    PrettyPrint('            </button> ');
    PrettyPrint('');
                    // Sort on alphabet
    ...
    PrettyPrint('');
                    // Next page
    PrettyPrint('            <button id="button_right" class="button_'.$locations.'" onClick="NextPage()"> ');
    PrettyPrint('                → ');
    PrettyPrint('            </button> ');
    ...
    PrettyPrint('        <div id="item_bar" class="item_'.$locations.'"> ');
                    GetListOfItems("locations");
    PrettyPrint('        </div> ');
    PrettyPrint('    </div> ');
    PrettyPrint('');
    ...
    PrettyPrint('            '.$dict_Locations["default_location"]);
    PrettyPrint('        </div> ');
    PrettyPrint('    </div> ');
    ...
    if (null !== filter_input(INPUT_GET, 'id')) {
        PrettyPrint('<script>');
        PrettyPrint('getItemFromDatabase("locations", '.filter_input(INPUT_GET, 'id').', "").then(locationsHelperLayout, console.log);');
        PrettyPrint('</script>');
    }
}?>
...
<script>
    ...
    async function locationsHelperLayout(information) {        
        ...
        for (var key in information)
        {
            ...
            if ((key === "name") || (key === "location_id") || (key === "order_id")) {
                continue;
            }
            ...
            if (((key === "book_start_vers") ||
                ...
                TableKey.innerHTML = "<?php echo $dict_LocationsParams["book_start_vers"]; ?>";
