var dict_PeoplesParams = {
	...
	"book_start_vers": "Eerste voorkomen",
	"book_end_vers": "Laatste voorkomen",
};

var dict_LocationsParams = {
	"location_id": "ID nummer",
	"name": "Naam",
	"descr": "Beschrijving",
	"meaning_name": "Betekenis naam",
	"type": "Type",
...
var dict_SpecialsParams = {
	"special_id": "ID nummer",
	"name": "Naam",
	"descr": "Beschrijving",
	"meaning_name": "Betekenis naam",
	"type": "Type",
...
var dict_BooksParams = {
	"book_id": "ID nummer",
	"name": "Naam",
	"descr": "Beschrijving",
	"num_chapters": "Aantal hoofdstukken",
	"summary": "Samenvatting",
};

var dict_EventsParams = {
	"event_id": "ID nummer",
	"name": "Naam",
	"descr": "Beschrijving",
	"length": "Lengte",
	"date": "Datum",
	"book_start_vers": "Begin vers",
...
var dict_Books = {
	"default_book": "<h1>Boeken</h1>Klik op een naam in de lijst om meer informatie te zien.<br><br>Gebruik de knoppen met de pijltjes aan de linkerkant om naar de vorige/volgende 100 namen te gaan (wanneer toepasselijk).<br><br>De knoppen met waarbij de pijltjes naar beneden wijzen, zijn om te kiezen hoe de namen worden gesorteerd:<br>- <b>Alfabetisch</b> (A boven, Z onder)<br>- <b>Omgekeerd alfabetisch</b> (Z boven, A onder)<br>- <b>Voorkomen in de bijbel</b> (1 boven, 9 onder)<br>- <b>Omgekeerd voorkomen in de bijbel</b> (9 boven, 1 onder)<br><br>Zodra je een sorteeroptie hebt gekozen, zal de sorteerknop worden gewijzigd naar de omgekeerde variant van wat je gekozen hebt.",
};

var dict_Events = {
	"default_event": "<h1>Gebeurtenissen</h1>Klik op een naam in de lijst om meer informatie te zien.<br><br>Gebruik de knoppen met de pijltjes aan de linkerkant om naar de vorige/volgende 100 namen te gaan (wanneer toepasselijk).<br><br>De knoppen met waarbij de pijltjes naar beneden wijzen, zijn om te kiezen hoe de namen worden gesorteerd:<br>- <b>Alfabetisch</b> (A boven, Z onder)<br>- <b>Omgekeerd alfabetisch</b> (Z boven, A onder)<br>- <b>Voorkomen in de bijbel</b> (1 boven, 9 onder)<br>- <b>Omgekeerd voorkomen in de bijbel</b> (9 boven, 1 onder)<br><br>Zodra je een sorteeroptie hebt gekozen, zal de sorteerknop worden gewijzigd naar de omgekeerde variant van wat je gekozen hebt.",
	"map_event": "Lijst van tijdslijnen waar dit event in voorkomt:",
};

var dict_Peoples = {
	"default_people": "<h1>Personen</h1>Klik op een naam in de lijst om meer informatie te zien.<br><br>Gebruik de knoppen met de pijltjes aan de linkerkant om naar de vorige/volgende 100 namen te gaan (wanneer toepasselijk).<br><br>De knoppen met waarbij de pijltjes naar beneden wijzen, zijn om te kiezen hoe de namen worden gesorteerd:<br>- <b>Alfabetisch</b> (A boven, Z onder)<br>- <b>Omgekeerd alfabetisch</b> (Z boven, A onder)<br>- <b>Voorkomen in de bijbel</b> (1 boven, 9 onder)<br>- <b>Omgekeerd voorkomen in de bijbel</b> (9 boven, 1 onder)<br><br>Zodra je een sorteeroptie hebt gekozen, zal de sorteerknop worden gewijzigd naar de omgekeerde variant van wat je gekozen hebt.",
	"map_people": "Lijst van stambomen waar deze persoon in voorkomt:",
};

var dict_Locations = {
	"default_location": "<h1>Locaties</h1>Klik op een naam in de lijst om meer informatie te zien.<br><br>Gebruik de knoppen met de pijltjes aan de linkerkant om naar de vorige/volgende 100 namen te gaan (wanneer toepasselijk).<br><br>De knoppen met waarbij de pijltjes naar beneden wijzen, zijn om te kiezen hoe de namen worden gesorteerd:<br>- <b>Alfabetisch</b> (A boven, Z onder)<br>- <b>Omgekeerd alfabetisch</b> (Z boven, A onder)<br>- <b>Voorkomen in de bijbel</b> (1 boven, 9 onder)<br>- <b>Omgekeerd voorkomen in de bijbel</b> (9 boven, 1 onder)<br><br>Zodra je een sorteeroptie hebt gekozen, zal de sorteerknop worden gewijzigd naar de omgekeerde variant van wat je gekozen hebt.",
};

var dict_Specials = {
	"default_special": "<h1>Speciaal</h1>Klik op een naam in de lijst om meer informatie te zien.<br><br>Gebruik de knoppen met de pijltjes aan de linkerkant om naar de vorige/volgende 100 namen te gaan (wanneer toepasselijk).<br><br>De knoppen met waarbij de pijltjes naar beneden wijzen, zijn om te kiezen hoe de namen worden gesorteerd:<br>- <b>Alfabetisch</b> (A boven, Z onder)<br>- <b>Omgekeerd alfabetisch</b> (Z boven, A onder)<br>- <b>Voorkomen in de bijbel</b> (1 boven, 9 onder)<br>- <b>Omgekeerd voorkomen in de bijbel</b> (9 boven, 1 onder)<br><br>Zodra je een sorteeroptie hebt gekozen, zal de sorteerknop worden gewijzigd naar de omgekeerde variant van wat je gekozen hebt.",
};
...
var select_Search_gender = {
	"male": "Man",
	"female": "Vrouw",
};

var select_Search_tribes = {
	"ruben": "Ruben",
	"simeon": "Simeon",
	"levi": "Levi",
	"juda": "Juda",
...
var dict_Worldmap = {
	"default_wm": "<h1>Wereldkaart</h1>Klik op een naam in de lijst om meer informatie te zien<br><br>De wereldkaart wordt weergegeven door middel van Google Maps, met pinnetjes voor alle locaties die bekend zijn.<br>Deze kaart kan je hetzelfde gebruiken als dat je gewend bent met Google Maps.",
	"loading_wm": "<h1>Wereldkaart aan het laden..</h1>",
	"link_location": "Klik om informatie te bekijken over deze locatie",
};
...
var dict_Contact = {
	...
	"contact": "Heb je vragen, tips, opmerkingen (zoals typfouten..) over de website of de inhoud ervan, of wil je ergens mee kunnen helpen?<br>Stuur dan een email naar ProDeoProductions2u@gmail.com, of vul het contactformulier hier beneden in om dit anoniem te doen.",
	"contact_form": "Contact formulier",
	"contact_subject": "Onderwerp",
	"contact_text": "Bericht",
	"contact_submit": "Stuur formulier",
	"contact_failed": "Het sturen van het bericht is mislukt.. Hier is de foutmelding:",
	"contact_succes": "Het bericht is verzonden!",
