...
$dict_PeoplesParams = array(
	...
	"PlaceOfBirthID"=>"ID nummer Geboorteplaats",
	"PlaceOfEnd"=>"Sterfplaats",
	"PlaceOfEndID"=>"ID nummer Sterfplaats",
	"PlaceOfLiving"=>"Woonplaats",
	"PlaceOfLivingID"=>"ID nummer Woonplaats",
	"Age"=>"Leeftijd",
	"Gender"=>"Geslacht",
	"Tribe"=>"Stam",
	"Profession"=>"Beroep",
...
$dict_EventsParams = array(
	...
	"PreviousID"=>"ID nummer Vorige Gebeurtenis",
	"Locations"=>"Locaties",
	"LocationIDs"=>"ID nummers Locaties",
	"Peoples"=>"Personen",
	"PeopleIDs"=>"ID nummers Personen",
	"Specials"=>"Specials",
	"SpecialIDs"=>"ID nummers Specials",
	"Description"=>"Gebeurtenissen",
	"FirstAppearance"=>"Begin vers",
	"LastAppearance"=>"Eind vers",
	"Others"=>"Overige",);
