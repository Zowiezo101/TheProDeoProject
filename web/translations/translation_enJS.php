...
var dict_Books = {
	"default_book": "<h1>Books</h1>Click on a name in the list for more information.<br><br>Use the buttons with the arrows on the left side to go to the previous/next 100 names (if applicable).<br><br>The buttons with the arrows pointing down, are for choosing how the names are sorted:<br>- <b>Alphabetical</b> (A on top, Z on the bottom)<br>- <b>Reversed alphabetical</b> (Z on top, A on the bottom)<br>- <b>Appearance in the bible</b> (1 on top, 9 on the bottom)<br>- <b>Reversed appearance in the bible</b> (9 on top, 1 on the bottom)<br><br>As soon as you select the sorting method, the button will change into the reversed method of what you selected.",
};

var dict_Events = {
	"default_event": "<h1>Events</h1>Click on a name in the list for more information.<br><br>Use the buttons with the arrows on the left side to go to the previous/next 100 names (if applicable).<br><br>The buttons with the arrows pointing down, are for choosing how the names are sorted:<br>- <b>Alphabetical</b> (A on top, Z on the bottom)<br>- <b>Reversed alphabetical</b> (Z on top, A on the bottom)<br>- <b>Appearance in the bible</b> (1 on top, 9 on the bottom)<br>- <b>Reversed appearance in the bible</b> (9 on top, 1 on the bottom)<br><br>As soon as you select the sorting method, the button will change into the reversed method of what you selected.",
	"map_event": "List of time lines this event is included in:",
};

var dict_Peoples = {
	"default_people": "<h1>Peoples</h1>Click on a name in the list for more information.<br><br>Use the buttons with the arrows on the left side to go to the previous/next 100 names (if applicable).<br><br>The buttons with the arrows pointing down, are for choosing how the names are sorted:<br>- <b>Alphabetical</b> (A on top, Z on the bottom)<br>- <b>Reversed alphabetical</b> (Z on top, A on the bottom)<br>- <b>Appearance in the bible</b> (1 on top, 9 on the bottom)<br>- <b>Reversed appearance in the bible</b> (9 on top, 1 on the bottom)<br><br>As soon as you select the sorting method, the button will change into the reversed method of what you selected.",
	"map_people": "List of family trees this person is included in:",
};

var dict_Locations = {
	"default_location": "<h1>Locations</h1>Click on a name in the list for more information.<br><br>Use the buttons with the arrows on the left side to go to the previous/next 100 names (if applicable).<br><br>The buttons with the arrows pointing down, are for choosing how the names are sorted:<br>- <b>Alphabetical</b> (A on top, Z on the bottom)<br>- <b>Reversed alphabetical</b> (Z on top, A on the bottom)<br>- <b>Appearance in the bible</b> (1 on top, 9 on the bottom)<br>- <b>Reversed appearance in the bible</b> (9 on top, 1 on the bottom)<br><br>As soon as you select the sorting method, the button will change into the reversed method of what you selected.",
};

var dict_Specials = {
	"default_special": "<h1>Specials</h1>Click on a name in the list for more information.<br><br>Use the buttons with the arrows on the left side to go to the previous/next 100 names (if applicable).<br><br>The buttons with the arrows pointing down, are for choosing how the names are sorted:<br>- <b>Alphabetical</b> (A on top, Z on the bottom)<br>- <b>Reversed alphabetical</b> (Z on top, A on the bottom)<br>- <b>Appearance in the bible</b> (1 on top, 9 on the bottom)<br>- <b>Reversed appearance in the bible</b> (9 on top, 1 on the bottom)<br><br>As soon as you select the sorting method, the button will change into the reversed method of what you selected.",
};
...
var dict_Worldmap = {
	"default_wm": "<h1>Worldmap</h1>Click on a name in the list for more information<br><br>The worldmap is displayed using Google Maps, with markers for all known locations.<br>Just use this map in the same way that you would use Google Maps.",
